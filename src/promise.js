...
// Utility library that provides promises.
...
/**
 * A promise. This is an internal type, to construct a promise in client code
 * use one of the static constructors below.
 */
...
/**
 * Returns a new promise that represents the result of constructor calling
 * the given constructor with the result of this promise.
 */
Promise.prototype.thenConstruct = function(Constructor) {
...
Promise.prototype.scheduleFireListener_ = function (listener, parentTraceOpt) {
  if (this.hasFailed()) {
    ...
    if (handler) {
      var ownTrace = (promise.trace ? new promise.trace.PromiseTrace(this.data_,
          this.traceSegment_, parentTraceOpt) : null);
